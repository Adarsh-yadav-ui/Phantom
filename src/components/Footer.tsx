...
export const Footer = () => {
  ...
  return (
    <footer className="my-8 px- max-w-5xl text-base-content mx-auto block">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between  gap-4 md:gap-10 px-2 md:px-8 flex-1">
          ...
          <div className="flex flex-col md:mx-4 md:flex-row gap-2 md:gap-20 items-start md:items-start">
            <div className="flex flex-col gap-1 md:gap-4">
              <h4 className="uppercase font-display text-md text-neutral/50 font-semibold">
                Resources
              </h4>
              <div className="flex flex-wrap md:flex-col gap-2 text-sm text-neutral items-start ">
                <Link
                  className="text-neutral/50 whitespace-nowrap font-medium"
                ...
                <Link
                  className="pointer-events-none text-neutral/50 whitespace-nowrap font-medium"
                  href="/resources/blog"
                >
                  Blog{" "}
                  <span className="inline-flex ml-1 py-0.5 px-3 bg-base-300 text-xs rounded-xl -rotate-3">
                    soon
                  </span>{" "}
                </Link>
                <Link
            ...
            <div className="hidden md:flex flex-col gap-1 md:gap-4">
              <h4 className="uppercase whitespace-nowrap font-display text-md text-neutral/50 font-semibold">
                Company{" "}
                <span className="inline-flex  ml-1 py-0.5 px-3 bg-base-300 text-xs rounded-xl rotate-3">
                  soon
                </span>
